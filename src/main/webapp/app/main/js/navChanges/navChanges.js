jQuery(document).ready(function () {
    ...
    jQuery(window).scroll(function () {
        ...
        if (windowScrollPosTop >= 150) {
            ...
            jQuery(".top-header img.logo").css({"margin-top": "-12px", "margin-bottom": "6"});
        ...
        var mapPosition = $("#scrollToMap").offset().top;
        var compareHashtagsPosition = $("#scrollToCompareHashtags").offset().top;
        ...
        if (homePositon <= scrollPosition && scrollPosition < hashtagPosition) {
            ...
            $("ul li:nth-child(5) a").removeClass("active");
            $("ul li:nth-child(6) a").removeClass("active");
        } else if (chartsPosition < scrollPosition && scrollPosition < mapPosition) {
            ...
            $("ul li:nth-child(5) a").removeClass("active");
            $("ul li:nth-child(6) a").removeClass("active");
        } else if (mapPosition < scrollPosition && scrollPosition < compareHashtagsPosition) {
            ...
            $("ul li:nth-child(4) a").removeClass("active");
            $("ul li:nth-child(6) a").removeClass("active");
        } else if (scrollPosition >= compareHashtagsPosition) {
